...
public class App implements RequestHandler<Object, Object> {
    ...
    public Object handleRequest(final Object input, final Context context) {
    	...
    	keycloak.realm(realmName).users().get(foundUser.getId()).logout();
    	    	
        return String.format("User: %s with username '%s' logged out of all sessions", foundUser.getId(), foundUser.getUsername());
    }
}
